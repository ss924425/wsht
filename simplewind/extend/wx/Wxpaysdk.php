...
class Wxpaysdk 
{
	...
	private $mchid = '1493018512'; //微信支付商户号
	private $mchkey = 'ileyptwn1zvfchqra50avbnrihrdzgbb'; //微信支付商户KEY
	...
	function createXml() {
        ...
        //return iconv('UTF-8','ISO8859-1',$this->arrayToXml($this->parameters));//签名错误修改
	}
	/**
	 * 	作用：post请求xml
	 */
