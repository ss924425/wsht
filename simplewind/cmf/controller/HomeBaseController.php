...
class HomeBaseController extends BaseController
{
    ...
    public function _initialize()
    {
        ...
        self::$_wxappid = self::$SET['wx_setting']['wxappid'];
        self::$_wxappsecret = self::$SET['wx_setting']['wxappsecret'];
    ...
    {
        $set['site_info'] = cmf_get_cmf_setting('site_info');
        $set['wx_setting'] = cmf_get_cmf_setting('wx_setting');
        $set['user_setting'] = cmf_get_cmf_setting('user_setting');
        return $set;
    }
