<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/admin\service\add_service.html";i:1595639861;s:83:"D:\phpStudy\PHPTutorial\WWW\wsht\public\themes\admin_simpleboot3\public\header.html";i:1564199040;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('service/index'); ?>">服务列表</a></li>
        <li class="active"><a href="<?php echo url('service/addService'); ?>">发布服务</a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('service/addServicePost'); ?>">
            ...
            <div class="col-md-6 col-sm-10">
                <select class="form-control" name="sortid" required id="sortid">
                    <?php if(is_array($sorts) || $sorts instanceof \think\Collection || $sorts instanceof \think\Paginator): $i = 0; $__LIST__ = $sorts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['id']; ?>" <?php if($info['id'] == $vo['id']): ?>selected<?php endif; ?> ><?php echo $vo['name']; ?></option>
...
<script type="text/javascript">
    ...
    $('#sortid').change(function () {
        var sid = $(this).val()
        // location.href = '<?php echo url("addTask"); ?>' + "?sid=" + sid;
    })
</script>
</body>
</html>