<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"themes/admin_simpleboot3/admin\service\servicesort_add.html";i:1595644247;s:83:"D:\phpStudy\PHPTutorial\WWW\wsht\public\themes\admin_simpleboot3\public\header.html";i:1564199040;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('service/serviceAdd'); ?>">新增分类</a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('service/servicesortAddPost'); ?>">
