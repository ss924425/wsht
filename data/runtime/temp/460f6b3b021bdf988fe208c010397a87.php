<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"themes/admin_simpleboot3/admin\\login.html";i:1595638353;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    <title>尉氏后台 <?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <link href="/themes/admin_simpleboot3/public/assets/themes/simpleadmin/login.css" rel="stylesheet">
    <!--[if lt IE 9]>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h1 class="text-center">尉氏县农业后台</h1>
